...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 0.2f, 1)), // 1
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.3f, 0.5f, 1)), // 2
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0.1f, 0, 1)), // 3
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 0.6f)), // 4
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 0, 0.5f)), // 5
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0.8f, 0, 0)), // 6
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 0.2f, 0.5f)), // 7
...

    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5f, 0.3f, 1)), // 0
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1)), // 1
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 0.1f)), // 2
            VertexFormat(glm::vec3(0.25f, 1, 0.25f), glm::vec3(0, 0.4f, 0.2f)), // 3
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1)), // 1
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 1)), // 2
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1)), // 3
        };
    ...
    //bonus 1 disc de cerc
    // tetraedtru fiecare fata are culori diferite, toate au culori complete

    {
        vector<VertexFormat> vertices
        {
            // 1st side
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5f, 0.3f, 1)), // 0
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.5f, 0.3f, 1)), // 1
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.5f, 0.3f, 1)), // 2

            // 2nd side
            VertexFormat(glm::vec3(0.25f, 1, 0.25f), glm::vec3(1, 0.2f, 1)), // 3
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0.2f, 1)), // 4
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.2f, 1)), // 5

            // 3rd side
            VertexFormat(glm::vec3(0.25f, 1, 0.25f), glm::vec3(0.6f, 1, 0.4f)), // 6
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.6f, 1, 0.4f)), // 7
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.6f, 1, 0.4f)), // 8

            // 4th side
            VertexFormat(glm::vec3(0.25f, 1, 0.25f), glm::vec3(1.,0.824,0.302)), // 9
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1.,0.824,0.302)), // 10
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1.,0.824,0.302)), // 11
...

    {
        ...
        vector< VertexFormat> vertices;
        vertices.push_back(VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1., 1., 0.302)));
        ...
        for (int i = 0; i <= num_segments; i++)
        {
            ...
            vertices.push_back(VertexFormat(glm::vec3(x, y, 0), glm::vec3(1., 0.549, 0.102)));
        }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1));

    // TODO(student): Draw the mesh that was created with `CreateMesh()`
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 0, 0), glm::vec3(1));

    // TODO(student): Draw the tetrahedron

    // TODO(student): Draw the square
    RenderMesh(meshes["cube_C"], shaders["VertexColor"], glm::vec3(2, 2, 0), glm::vec3(1));

    RenderMesh(meshes["cube_D"], shaders["VertexColor"], glm::vec3(0, 2, 0), glm::vec3(1));

    RenderMesh(meshes["cube_E"], shaders["VertexColor"], glm::vec3(-2, 2, 0), glm::vec3(1));
